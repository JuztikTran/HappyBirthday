...
const Cake = () => {
    ...
    const handleBlow = () => {
        if (candlesLit) {
            // tắt nến
            setTimeout(() => {
                setCandlesLit(false);// hiện thư sau khi tắt nến
            }, 1000);
        }
    };
    return (
        <div className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-cyan-800 to-blue-950">
            {/* Hiệu ứng ngôi sao */}
      ...
      c-7.606-0.447-6.058-37.895-20.62-23.333c-10.167,10.166-15.972-0.747-25,12C119.547,443.568,121.798,416.515,111.547,415.233z
                    ...
                    <div className={`${pacifico.className} flex-col text-center space-y-2`}>
                        <h1 className="text-4xl text-orange-300">Happy birthday!</h1>
                        {/* <p className="text-6xl font-handwriting text-amber-700 font-bold animate-bling mt-6 drop-shadow-md">
                    {process.env.NEXT_PUBLIC_NAME}
                </p> */}
                        <p className="text-5xl sm:text-5xl md:text-6xl text-[#ffcc00] font-bold animate-bling mt-6 drop-shadow-md break-words px-4">
                            {process.env.NEXT_PUBLIC_NAME} 
                        </p>
                    </div>
            ...
            {
                !candlesLit && showLetter && <BirthdayLetter onClose={() => {
                    setShowLetter(false);
                    setShowWishes(true);
                }} />
            }
            {
                showWishes && <FallingMessage />
            }
        </div>
